...
\item 0-9 (the digits)
\end{itemize}
The EOFs or EOFi may chose freely any of the \emph{56800235584}
possibilities.\footnote{$(26+26+10)^6$, as long as EOF\_L\_ID is 6.}
...
EOFi acknowledge (i.e everything went well).
\begin{longtable}{|c|c|c|c|}
...
The last issued command did fail. Details are specified in the reason message.
...
\begin{longtable}{|c|c|c|c|}
\caption{2105: /peer rename parameters}\\
\hline
\textbf{Parameter} & \textbf{Type} & \textbf{Description} & \textbf{Example}\\
\hline
Nick name & EOFsdt & Nick name, as known by EOFi & karl-otto\\
...
The EOFi will not answer, but sent an exit request to all other
EOFs.
\\
\subsubsection{Parameters}
\begin{itemize}
