...
EOFi acknowledged the last command.
\begin{itemize}
...
The EOFi does not accept / understand the request.
\begin{longtable}{|c|c|c|c|}
...
Nick & EOFsdt & Name you identify the peer with & telmich\\
\hline
Address & EOFsdt & Where we can make the first contact & tcp:10.0.42.42:4242\\
\hline
Keyid & EOFsdt & PGP fingerprint of the peers key & F27987E34E66...\\
\hline
\end{longtable}
Possible answers:
\begin{itemize}
...
\item 40 Byte containing the keyid of the
...
There is no transfer of binary numbers between \textbf{EOFi} and \textbf{pmg}.
...
\textbf{EOFi} begin with \textbf{1} ("`1023"' for instance).
...
\end{itemize}
\item \textbf{1}: \textbf{EOFi} messages
\begin{itemize}
\item \textbf{10}: \textbf{EOFi} (de-)initialisation
\item \textbf{11}: \textbf{EOFi} success messages
\item \textbf{12}: \textbf{EOFi} error messages
\item \textbf{13}: \textbf{EOFi} peer messages
\end{itemize}
\end{itemize}
...
version of the client to EOF protocol it speaks. This specification
