...
% -----------------------------------------------------------------------------
\section{Authors}
The list of persons who contributed to EOF, in chronical order.
Add yourself to the list, when you coded something for EOF.
% -----------------------------------------------------------------------------
\subsection{Nico -telmich- Schottelius}
Nico is the initiator and main coder of EOF. Parts done by him are:
\begin{itemize}
\item Organise meetings
\item Project coordination
\item First EOFi (ceofhack)
\end{itemize}
More information about Nico can be retrieved from
\begin{itemize}
\item http://nico.schottelius.org/
\end{itemize}
% ----------------------------------------------------------------------------
