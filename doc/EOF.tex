...
\section{Paths}
% -----------------------------------------------------------------------------
\subsection{EOFi configuration directory (p\_eofi\_d)}
\label{peofid}
% -----------------------------------------------------------------------------
...
% Nico: 1.0
% -----------------------------------------------------------------------------
\subsection{User interface (p\_ui\_socket)}
\label{puisocket}
...
% Nico: 1.0
% -----------------------------------------------------------------------------
\subsection{Crypto engine (p\_crypto\_d, p\_crypto\_mykeyid)}
\label{pcryptod}
\label{pcryptomykeyid}
...
% -----------------------------------------------------------------------------
\subsection{Transport protocols (p\_tp\_d)}
\label{ptpd}
The directory "'\textbf{tp}"' below the EOFi configuration directory contains
all transport protocol related files.
% -----------------------------------------------------------------------------
...
(to prevent problems with broken filesystems).
% -----------------------------------------------------------------------------
\subsection{Paths}
...
\end{longtable}
% -----------------------------------------------------------------------------
\subsection{Developing implementations}
...
% -----------------------------------------------------------------------------
\subsection{Integrating implementations}
If you want to add an implementation of the transport protocol
\emph{http} for instance:
\begin{itemize}
