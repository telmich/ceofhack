...
When a transport protocol is started by EOFi, the following
information is available:

\begin{longtable}{|c|c|c|c|}
\caption{Command line arguments for transport protocols}\\
\hline
\textbf{Parameter} & \textbf{Type} & \textbf{Description} & \textbf{Example}\\
\hline
ARGV[1]: Destination & URL without scheme & The \emph{proto:} part is stripped of & 127.0.0.3:42\\
\hline
\end{longtable}
...
waits for an acknowledge, before it is marked as enabled.
\begin{longtable}{|c|c|c|c|}
