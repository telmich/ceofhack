...
\item No dependency on a central system.
...
% -----------------------------------------------------------------------------
\section{Motivation}
There are many different chat protocols available like
\begin{itemize}
\item talk
\item IRC
\item SILC
...
\item Skype
\end{itemize}
Only one of those protocols contains mandority encryption (SILC), which
still lacks many features for secure chatting.\footnote{Most of them can be
enhanced to use TLS/SSL, but this is not enforced.}
...
was wie geplant ist, jetziger status, woran wir sind
% -----------------------------------------------------------------------------
\subsection{3 phases}
Bigger project, was clear at beginning.
Thus dividided into three phases:
EOF-1, EOF-2, EOF-3
% -----------------------------------------------------------------------------
\subsection{Current status}
Working on prototype EOF-2.
% -----------------------------------------------------------------------------
...
methods.\footnote{See pipe(2), forkexecpipe() in rEOFi.}
